...
DELETE FROM COMPANY WHERE ID = 7; #Deleting selected record from table

DELETE FROM COMPANY; #Deleting all the records of the table
...
SELECT date('now');  #Computes the current date

SELECT date('now','start of month','+1 month','-1 day');  #last day of the current month

SELECT datetime(1092941466, 'unixepoch', 'localtime');


SELECT strftime('%s','now');  #computes the current UNIX timestamp
